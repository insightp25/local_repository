...
class ItemRepositoryTest {
    ...
    void save() {
        // given
        Item item = new Item("tobySpring", 60000, 10);
    ...
    void findAll() {
        // given
        Item item1 = new Item("tobySpring", 60000, 10);
        Item item2 = new Item("definitiveHttp", 30000, 15);
    ...
    void updateItem() {
        ...
        // when
        Item updateParam = new Item("GodFather", 100000, 5);
