...
public class AspectV6Advice {
    ...
    @Around("haro.aop.order.aop.Pointcuts.orderAndService()")
    ...
    @Before("haro.aop.order.aop.Pointcuts.orderAndService()")
    ...
    @After(value = "haro.aop.order.aop.Pointcuts.orderAndService()")
